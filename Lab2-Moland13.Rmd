...
tbl_2way %>% 
    ...
    cols_label(bol = "Bolærne",
               flo = "Kvernskjær",
               kve = "Flødevigen"
        
    ) |> 
    tab_source_note( "Source: Moland et al., 2013")
...
tbl_3way %>%
  ...
  subtitle = "Aggregated totals of CPUE by year for each region and treatment"
    ...
    tab_spanner(label = "Flødevigen",
                columns = c("flo_con", "flo_mpa")) |> 
    tab_spanner(label = "Kvernskjær",
